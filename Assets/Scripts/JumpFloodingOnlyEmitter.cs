...
public class JumpFloodingOnlyEmitter : MonoBehaviour
{
    ...
    {
        GetComponentInParent<JumpFloodingOnlyBlitter>()?.emitters.Add(this);
    }

    private void OnDisable()
    {
        GetComponentInParent<JumpFloodingOnlyBlitter>()?.emitters.Remove(this);
    }

    private void OnValidate()
    {
        JumpFloodingOnlyBlitter blitter = GetComponentInParent<JumpFloodingOnlyBlitter>();
